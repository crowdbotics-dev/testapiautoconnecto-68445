...
## Project Structure
    ...
    ├── testapiautoconnecto_68445  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68445`
...
2. Clone this repo and `cd testapiautoconnecto_68445`
